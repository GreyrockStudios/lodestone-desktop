...
// Uses Node's https module for buffered API proxy requests.
// SSE streaming endpoints bypass the protocol handler entirely
// (frontend uses absolute https:// URL directly).
