...
function setupAutoUpdater() {
  ...
  autoUpdater.on('update-downloaded', (info) => {
    ...
    // Show a native notification so the user knows to restart
    if (Notification.isSupported()) {
      const notification = new Notification({
        title: 'Lodestone Update Ready',
        body: `Version ${info.version} will be installed when you quit the app. Restart now to update.`,
        silent: false,
      });
